    ...
    const skillQuestions = {
      javascript:  [
                ...
                },
                {
                    ...
                    correctAnswer: "A technique for attaching events to multiple elements"
                },
                {
                    id: 3,
                    ...
                    correctAnswer: "== compares values with type coercion, === compares without type coercion"
                },
                {
                    id: 4,
      ...
      reactjs: [
                {
                    ...
                    correctAnswer: "A syntax extension that allows writing HTML within JavaScript"
                },
                {
                    id: 2,
                ...
                },
                {
                    ...
                    correctAnswer: "Functions that allow you to use state and other React features in functional components"
                },
                {
                    id: 4,
  ...
  const calculateResults = async () => {
    ...
    try {
      await axios.post("http://localhost:3000/updateSkillLevel", {
        skill,
        level,
        email: localStorage.getItem("userEmail"), // Use optional chaining to avoid errors
      });
