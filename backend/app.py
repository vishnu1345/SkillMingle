...
#         # General skills list for fallback
#         self.general_skills = [
...
#         # Check for a direct match in the predefined categories
...
#         else:
#             # Fall back to general skill extraction using cosine similarity
